...
void send_message(int socket_fd, const char *message, std::size_t msg_size) {
    ...
    do {
        ...
        // NOTE: Successful completion of a call to sendData() does not guarantee delivery of the message. A return value of -1 indicates only locally-detected errors.
